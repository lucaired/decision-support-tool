...
function App() {
    ...
    const saveProjectHandler = (project: object) => {
        ...
        axios.post(`http://${backendUrl}/projects/`, project)
        // @ts-ignore
    ...
    const updateProjectHandler = (project) => {
        ...
        axios.put(`http://${backendUrl}/projects/${project._id}`, updateSet)
        // @ts-ignore
        .then(function (response) {
        // @ts-ignore
            if (response.data) {
    ...
    const removeProjectHandler = (projectId: string) => {
        axios.delete(`http://${backendUrl}/projects/${projectId}`)
        // @ts-ignore
        .then(function (response) {
    ...
    const queryProjects = () => axios.get(`http://${backendUrl}/projects/`)
    // @ts-ignore
    .then(function (response) {
    ...
    const queryMatchingProjects = (variantsToDesignEpisodes: Object) => {
        ...
        return axios.post(`http://${backendUrl}/matchings/project/${projectId}/match_by_design_episodes`, variantsToDesignEpisodes)
        // @ts-ignore
        .then(function (response) {
